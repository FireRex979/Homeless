...
<?php $__env->startSection('judul','User | Detail Perumahan'); ?>
                                        ...
                                        <div class="box-widget-item fl-wrap">
                                            ...
                                            <div class="box-widget opening-hours">
                                                <div class="box-widget-content">
                                                    ...
                                                    <ul>
                                                        <?php for($i=1;$i<=7;$i++): ?>
                                                        <li><span class="opening-hours-day">Tipe <?php echo e($i); ?> </span><span class="opening-hours-time"><a href="" class="modal-tipe-open"><i class="fa fa-eye" style="background-color: #3EAAFD; padding: 10px 10px; border-radius: 5px; color: white;"></i></a></span></li>
                                                        <?php endfor; ?>
                                                    </ul>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perumahan\resources\views/user/detail_residence.blade.php ENDPATH**/ ?>