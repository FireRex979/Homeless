...
<html lang="en">
    <head>
        ...
        <!--=============== css  ===============-->
        <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/user/css/reset.css')); ?>">
        <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/user/css/plugins.css')); ?>">
        <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/user/css/style.css')); ?>">
        <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/user/css/color.css')); ?>">
        <!--=============== favicons ===============-->
    ...
    <body>
        ...
        <!-- Main end -->
        <!--=============== scripts  ===============-->
        <script type="text/javascript" src="<?php echo e(asset('assets/user/js/jquery.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/user/js/plugins.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/user/js/scripts.js')); ?>"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwJSRi0zFjDemECmFl9JtRj1FY7TiTRRo&libraries=places&callback=initAutocomplete"></script>
    </body>
</html><?php /**PATH C:\xampp\htdocs\perumahan\resources\views/layouts/user.blade.php ENDPATH**/ ?>