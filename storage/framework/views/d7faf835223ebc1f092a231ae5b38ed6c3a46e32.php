                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            ...
                                            <div class="geodir-category-content fl-wrap">
                                                ...
                                                <h3><a href="listing-single.html">Perumahan <?php echo e($i); ?></a></h3>
                                                <p>Kelebihan Perumahan 1.  </p>
                                                <p>Kelebihan Perumahan 2.  </p>
                                                <div class="geodir-category-options fl-wrap">
                                                    <div class="geodir-category-location"><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i> Alamat Perumahan <?php echo e($i); ?></a></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                        ...
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Berita <?php echo e($i); ?></a></h3>
                            ...
                            <div class="testimonials-carousel single-carousel fl-wrap">
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="testimonilas-avatar-item">
                                        ...
                                        <h4>Tester <?php echo e($i); ?></h4>
                                        <span>Pekerjaan Tester <?php echo e($i); ?></span>
                                    </div>
                                </div>
                                <?php endfor; ?>
                                <!--slick-slide-item end-->
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perumahan\resources\views/user/home.blade.php ENDPATH**/ ?>